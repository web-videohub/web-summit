...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/channel_room.css?after">
                ...
                <div id="chat-page" class="hidden">
                    <div class="chat-container">
                        <div class="chat-header">
                            <input type="text" id="search" placeholder="검색하기"/>
                            <button type="button" class="searchBtn" onclick="searchFriend()">찾기</button>
                        </div>
